---
title: Run an IBC Relayer
sidebar_label: Run an IBC Relayer
---
# Run an IBC Relayer

Learn how to run an IBC Relayer for Point Chain.
...
```bash
# In this example, we will set channel-292 on the cosmoshub-4 chain settings and channel-3 on the point_10687-1 chain settings:
[[chains]]
id = 'cosmoshub-4'
...
```bash
hermes query packet unreceived-packets point_10687-1 transfer channel-3
...
```bash
hermes tx raw packet-recv point_10687-1 cosmoshub-4 transfer channel-292

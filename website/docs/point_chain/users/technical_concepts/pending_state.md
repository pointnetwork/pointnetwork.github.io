---
title: Pending State
sidebar_label: Pending State
---


# Pending State

Learn how Point Chain handles pending state queries.
...
Point Chain is designed quite differently on this front as there is no concept of a "pending state".
Point Chain uses [Tendermint Core](https://docs.tendermint.com/) BFT consensus which provides instant
...
first-in-first-out (FIFO) fashion. Transactions on Point Chain cannot be ordered or cherry picked out from the Tendermint node [mempool](https://docs.tendermint.com/master/tendermint-core/mempool/).

...
| ------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------ |
| **Cosmos [gRPC](#cosmos-grpc)**                        | Query or send Point Chain transactions using gRPC                                          | `9090`       |
| **Cosmos REST ([gRPC-Gateway](#cosmos-grpc-gateway))** | Query or send Point Chain transactions using an HTTP RESTful API                           | `9091`       |
...
| **Command Line Interface ([CLI](#cli))**               | Query or send Point Chain transactions using your Terminal or Console.                     | N/A          |
...
Point Chain supports most of the standard [JSON-RPC APIs](./json-rpc/server.md) to connect with existing Ethereum-compatible web3 tooling.
...
Users can use the `pointd` binary to interact directly with an Point Chain node
though the CLI.

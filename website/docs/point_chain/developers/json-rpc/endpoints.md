...
# JSON-RPC Methods
:::note
Check the JSON-RPC methods supported on Point.
:::
...
Make sure your `pointd start` call is not using the flag `minimum-gas-prices` because this value will be used instead of the one set on the configuration file.
